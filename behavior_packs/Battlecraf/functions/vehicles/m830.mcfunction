...
execute @e[type=battlefield:m1a2,r=5] ~~~ tag @p add m830_firing
execute @e[type=battlefield:m1a2,r=5] ~~~ clear @p bullet:m830 0 1
...
execute @e[type=battlefield:leopard,r=5] ~~~ tag @p add m830_firing
execute @e[type=battlefield:leopard,r=5] ~~~ clear @p bullet:m830 0 1
...
execute @e[type=battlefield:challenger,r=5] ~~~ tag @p add m830_firing
execute @e[type=battlefield:challenger,r=5] ~~~ clear @p bullet:m830 0 1
